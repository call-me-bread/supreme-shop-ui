export const Product = () => {
    return (
        <>
            ...
            <div className="bg-white shadow-md rounded-lg max-w-xl m-2 dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <div className="px-5 pb-5">
                    <a href="#">
                        <h3 className="text-gray-900 font-semibold text-xl tracking-tight dark:text-white">Apple Watch
                            Series 7
